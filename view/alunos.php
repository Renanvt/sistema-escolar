  ...
  <main class="d-flex container align-items-center" style="height: calc(100vh - 56px); ">
    ...
    <div class="div" style="width: 100%;">
      <div class="row">
        <a type="button" class="btn btn-success" href="./adicionar_aluno.php">Adicionar Aluno</a>
      </div>
        ...
        <table class="table table-hover table-dark">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td style="width: 25%">
                <a type="button" class="btn btn-info" href="./visualizar_aluno.php?id=<?=$student->getId();?>">Visualizar</a>
